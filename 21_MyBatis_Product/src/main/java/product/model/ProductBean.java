...
public class ProductBean {
	...
	@Length(min = 2, max = 10, message = "상품 이름은 최소 2자리 최대 10자리 입니다.")
	private String name;
	...
	@Min(value = 3000, message = "가격은 최소 1000원 이상입니다.")
	private int price;
	
	private String category;
	
	@Length(min = 4, max = 10, message = "상품 설명은 최소 4자리 최대 10자리 입니다.")
	...
	private String upload2; //수정, 삭제하려는 파일명
